namespace MinorShift.Emuera.Forms
{
	partial class ConfigDialog
	{
		...
		private void InitializeComponent()
		{
			...
			this.toolTip1.SetToolTip(this.buttonReboot, resources.GetString("buttonReboot.ToolTip"));
			...
			this.toolTip1.SetToolTip(this.tabEnvironment, resources.GetString("tabEnvironment.ToolTip"));
			...
			this.toolTip1.SetToolTip(this.tabPageView, resources.GetString("tabPageView.ToolTip"));
			...
			this.toolTip1.SetToolTip(this.comboBoxTextDrawingMode, resources.GetString("comboBoxTextDrawingMode.ToolTip"));
			// 
			// label1
			// 
			...
			this.toolTip1.SetToolTip(this.tabPageWindow, resources.GetString("tabPageWindow.ToolTip"));
			...
			this.toolTip1.SetToolTip(this.ScrollRange, resources.GetString("ScrollRange.ToolTip"));
			// 
			// numericUpDown8
			// 
			...
			this.toolTip1.SetToolTip(this.numericUpDownPosY, resources.GetString("numericUpDownPosY.ToolTip"));
			// 
			// numericUpDownPosX
			// 
			resources.ApplyResources(this.numericUpDownPosX, "numericUpDownPosX");
			this.numericUpDownPosX.Name = "numericUpDownPosX";
			this.toolTip1.SetToolTip(this.numericUpDownPosX, resources.GetString("numericUpDownPosX.ToolTip"));
			// 
			// button1
			// 
			...
			this.toolTip1.SetToolTip(this.tabPageFont, resources.GetString("tabPageFont.ToolTip"));
			...
			this.toolTip1.SetToolTip(this.colorBoxBacklog, resources.GetString("colorBoxBacklog.ToolTip"));
			// 
			// colorBoxSelecting
			// 
			...
			this.toolTip1.SetToolTip(this.colorBoxSelecting, resources.GetString("colorBoxSelecting.ToolTip"));
			// 
			// colorBoxFG
			// 
			...
			this.toolTip1.SetToolTip(this.colorBoxFG, resources.GetString("colorBoxFG.ToolTip"));
			// 
			// colorBoxBG
			// 
			...
			this.toolTip1.SetToolTip(this.colorBoxBG, resources.GetString("colorBoxBG.ToolTip"));
			// 
			// tabPageSystem
			// 
			...
			this.toolTip1.SetToolTip(this.tabPageSystem, resources.GetString("tabPageSystem.ToolTip"));
			...
			this.toolTip1.SetToolTip(this.checkBoxSystemFullSpace, resources.GetString("checkBoxSystemFullSpace.ToolTip"));
			...
			this.toolTip1.SetToolTip(this.tabPageSystem2, resources.GetString("tabPageSystem2.ToolTip"));
			...
			this.toolTip1.SetToolTip(this.checkBoxSystemTripleSymbol, resources.GetString("checkBoxSystemTripleSymbol.ToolTip"));
			...
			this.toolTip1.SetToolTip(this.tabPageCompati, resources.GetString("tabPageCompati.ToolTip"));
			...
			this.toolTip1.SetToolTip(this.tabPageDebug, resources.GetString("tabPageDebug.ToolTip"));
			...
			this.toolTip1.SetToolTip(this.comboBoxReduceArgumentOnLoad, resources.GetString("comboBoxReduceArgumentOnLoad.ToolTip"));
